...
namespace Transaction\AppAccount;
 ...
 *
 * Generated from protobuf message <code>transaction.AppAccount.baseAccount</code>
 */
class baseAccount extends \Google\Protobuf\Internal\Message
{
    ...
    protected $address = '';
    /**
     * Generated from protobuf field <code>repeated .transaction.Token coins = 2;</code>
     */
    private $coins;
    /**
     ...
     *
     *     @type string $address
     *     @type \Transaction\Token[]|\Google\Protobuf\Internal\RepeatedField $coins
...
class_alias(baseAccount::class, \Transaction\AppAccount_baseAccount::class);
